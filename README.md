...
- Cloud Functions - 한 달에 2 백만 건의 호출 (백그라운드 및 HTTP 호출 모두 포함)
...
- Cloud Build - 하루 120 분
- Cloud Source Repositories - 최대 5 명의 사용자, 50GB 스토리지, 50GB 송신
...
- [github.com](https://github.com/) — 무제한 공개 리포지토리 및 무제한 개인 리포지토리 (최대 3 명)
- [bitbucket.org](https://bitbucket.org/) — CI / CD 용 파이프 라인을 사용하여 최대 5 명의 사용자를 위한 무제한 공개 및 비공개 리포지토리 (Git 및 Mercurial)
- [gitlab.com](https://about.gitlab.com/) — 무제한 공동 작업자와 무제한 공용 및 개인 Git 리포지토리
- [chiselapp.com](http://chiselapp.com/) — 무제한 public 및 private fossil 저장소
- [Azure DevOps](https://azure.microsoft.com/services/devops/) — 최대 5 명의 사용자 / 팀을위한 무제한 개인 저장소 (Git 및 TFS)
- [plasticscm.com](https://plasticscm.com/) — 개인, OSS 및 비영리 단체에 무료
- [codebasehq.com](https://www.codebasehq.com/) — 100MB의 공간과 2 명의 사용자를 가진 하나의 무료 프로젝트
- [NotABug](https://notabug.org) — NotABug.org는 Git 기반의 무료 라이센스 프로젝트를위한 자유 소프트웨어 코드 협업 플랫폼입니다
- [perforce.com](https://www.perforce.com/products/helix-teamhub) — 무료 1GB 클라우드 및 Git, Mercurial 또는 SVN 리포지토리.
- [projectlocker.com](https://projectlocker.com) — 50MB의 공간이있는 하나의 무료 개인 프로젝트 (Git 및 Subversion)
- [ionicframework.com](https://ionicframework.com/appflow) - Ionic으로 응용 프로그램을 개발하기위한 Repo 및 도구
- [gitea.com](https://www.gitea.com/) - 무제한 공개 및 비공개 Git 저장소
...
- discordapp.com — 공개 / 개인 실 및 VoIP 서비스와 채팅합니다. 무제한 사용자에게는 무료입니다.
...
- igloosoftware.com — 문서, 블로그 및 캘린더 등을 공유하기 위한 내부 포털. 최대 10 명의 사용자에게 무료로 제공됩니다.
...
- haveibeenpwned.com — 위반에 대한 정보를 가져 오기 위한 REST API.
...
- w.tools - 무료 CDN, 백업, 방화벽, 바이러스 백신 및 모니터링.
...
## 지도상의 데이터 시각화
 ...
 - osmnames.org — 지오 코딩, 관련 Wikipedia 페이지의 인기에 의해 순위가 매겨진 검색 결과
 - maptiler.com —지도 시각화를위한 벡터지도,지도 서비스 및 SDK. 주간 업데이트 및 4 가지 맵 스타일의 무료 벡터 타일.
 - developer.here.com —지도 및 위치 인식 앱을위한 API 및 SDK. 한 달에 2 만 건의 거래가 무료로 제공됩니다. 
...
- Coder — Visual Studio Code를 중심으로 전체 개발 환경을 구축하는 플랫폼입니다. 프리 티어에서는 2GB의 프로젝트와 2GB의 컨테이너 공간과 5 시간의 빠른 시간을 확보 할 수 있습니다 (사용 가능한 경우 컨테이너를 동적으로 확장).
...
- currencylayer.com — 비즈니스를 위한 안정적인 환율 및 환율 변환, 월 1,000 건의 API 요청 무료
